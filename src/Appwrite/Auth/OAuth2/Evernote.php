...
class Evernote extends OAuth2
{
    ...
    {
        $url = $this->endpoint[$this->environment] . 'oauth?' .
            \http_build_query([
                ...
                'oauth_callback' => \str_replace("localhost", "127.0.0.1", $this->callback),
     ...
     *
     * @link https://developer.paypal.com/docs/identity/v1/#userinfo_get
     *
     * @param string $accessToken
     *
     * @return bool
